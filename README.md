...
<head>
  ...
  <title>Eksperymenty Sławosza Uznańskiego‑Wiśniewskiego — IGNIS (Prezentacja)</title>
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;600;800&display=swap" rel="stylesheet">
  <style>
    :root{
      --bg1:#07142a; --bg2:#081022; --card:#0f1724; --accent:#ff6b35; --accent-2:#ff9a5a; --muted:#9aa4b2;
    }
    *{box-sizing:border-box}
    html,body{height:100%;margin:0;font-family:Inter,system-ui,Segoe UI,Roboto,Arial,sans-serif;background:linear-gradient(180deg,var(--bg1), #041129);color:#e9f1fb}
    .app{min-height:100vh;display:flex;align-items:center;justify-content:center;padding:36px}
    .frame{width:1100px;max-width:96%;background:linear-gradient(180deg,rgba(255,255,255,0.02),rgba(255,255,255,0.01));border-radius:18px;box-shadow:0 18px 60px rgba(2,6,20,0.7);overflow:hidden}

    /* Top bar */
    header{display:flex;align-items:center;gap:18px;padding:20px 28px;border-bottom:1px solid rgba(255,255,255,0.03)}
    .logo{width:68px;height:68px;border-radius:12px;background:linear-gradient(135deg,var(--accent),var(--accent-2));display:flex;align-items:center;justify-content:center;font-weight:800;color:#071022;font-size:18px}
    .title-wrap{flex:1}
    h1{margin:0;font-size:20px;letter-spacing:-0.02em}
    .sub{color:var(--muted);font-size:13px;margin-top:6px}

    /* Layout */
    .inner{display:grid;grid-template-columns:1fr 320px;gap:18px;padding:22px}
    .slide-area{background:linear-gradient(180deg,rgba(255,255,255,0.015),transparent);padding:18px;border-radius:12px;border:1px solid rgba(255,255,255,0.03);min-height:620px;display:flex;flex-direction:column}
    ...
    .btn.primary{background:linear-gradient(90deg,var(--accent),var(--accent-2));border:none;color:#071022;font-weight:700}

    /* Slide */
    .slide{flex:1;display:flex;flex-direction:column;align-items:flex-start;justify-content:center;padding:26px;position:relative}
    .slide h2{margin:0 0 8px 0;font-size:28px}
    .slide p{margin:8px 0 12px 0;color:#d8e6f7}
    .kicker{display:inline-block;background:rgba(255,255,255,0.03);padding:6px 10px;border-radius:999px;font-weight:700;color:var(--accent);margin-bottom:12px}

    .content-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:8px}
